...
class SmartCart:
    def __init__(self):
        ...
        self.goal_pose.pose.pose.position.x = 0.0
        self.goal_pose.pose.pose.position.y = 0.0
        self.current_pose = PoseWithCovarianceStamped()
        self.current_pose.pose.pose.position.x = 0.0
        self.current_pose.pose.pose.position.y = 0.0
        self.starting_pose = PoseWithCovarianceStamped()
        self.starting_pose.pose.pose.position.x = 0.0
        self.starting_pose.pose.pose.position.y = 0.0
    ...
    def odomProcess(self, odomData):
        self.current_pose.pose.pose.position.x = odomData.pose.pose.position.x
        self.current_pose.pose.pose.position.y = odomData.pose.pose.position.y
...
#1) GETTING NEXT GOAL FROM USER
    def getNextGoal(self):
        ...
        self.goal_pose.pose.pose.position.x = float(input("Set your x goal in metres: "))
        self.goal_pose.pose.pose.position.y = float(input("Set your y goal in metres: "))


        # # to command robot to move along the perimeter of a 2m x 1m rectangle
        # if(self.goalIndex == 0):
        #     self.goal_pose.pose.pose.position.x = WP0.position.x
        #     self.goal_pose.pose.pose.position.y = WP0.position.y
        #     self.goalIndex += 1
        #     rospy.sleep(1.0)
        # elif(self.goalIndex == 1):
        #     self.goal_pose.pose.pose.position.x = WP1.position.x
        #     self.goal_pose.pose.pose.position.y = WP1.position.y
        #     self.goalIndex += 1
        #     rospy.sleep(1.0)
        # elif(self.goalIndex == 2):
        #     self.goal_pose.pose.pose.position.x = WP2.position.x
        #     self.goal_pose.pose.pose.position.y = WP2.position.y
        #     self.goalIndex += 1
        #     rospy.sleep(1.0)
        # elif(self.goalIndex == 3):
        #     self.goal_pose.pose.pose.position.x = WP3.position.x
        #     self.goal_pose.pose.pose.position.y = WP3.position.y
        #     self.goalIndex += 1
        #     rospy.sleep(1.0)
        # elif(self.goalIndex == 4):
        #     self.goal_pose.pose.pose.position.x = WP4.position.x
        #     self.goal_pose.pose.pose.position.y = WP4.position.y
        #     self.goalIndex += 1
        #     rospy.sleep(1.0)
        # elif(self.goalIndex == 5):
        #     self.goal_pose.pose.pose.position.x = WP5.position.x
        #     self.goal_pose.pose.pose.position.y = WP5.position.y
        #     self.goalIndex = 0
        #     rospy.sleep(1.0)
        ...
        if self.euclidean_distance() > DISTANCE_TOLERANCE:
            ...
            self.starting_pose.pose.pose.position.x = self.current_pose.pose.pose.position.x
            self.starting_pose.pose.pose.position.y = self.current_pose.pose.pose.position.y
    ...
    def euclidean_distance(self):
        return sqrt( pow((self.goal_pose.pose.pose.position.x - self.current_pose.pose.pose.position.x), 2) + pow((self.goal_pose.pose.pose.position.y - self.current_pose.pose.pose.position.y), 2) )
    ...
    def distance_travelled(self):
        ...
        return sqrt( pow((self.starting_pose.pose.pose.position.x - self.current_pose.pose.pose.position.x), 2) + pow((self.starting_pose.pose.pose.position.y - self.current_pose.pose.pose.position.y), 2) )
...
#2) TURNING TO GOAL
    ...
    def get_deltaYaw(self):
        ...
        self.deltaYaw_unfiltered = atan2(self.goal_pose.pose.pose.position.y - self.current_pose.pose.pose.position.y, self.goal_pose.pose.pose.position.x - self.current_pose.pose.pose.position.x) - self.currentYaw

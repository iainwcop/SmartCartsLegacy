...
DISTANCE_TOLERANCE = 0.05   #robot will travel to this value in metres around the goal position
...
class SmartCart:
    def __init__(self):
        ...
        self.goalYaw = 0.0  #goal's angle in radians relative to odom frame's positive x-axis; CCW is positive

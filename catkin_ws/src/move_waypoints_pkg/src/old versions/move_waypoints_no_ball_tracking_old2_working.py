...
WP1 = Pose(Point(0.0,1.0,0.0), Quaternion(0.0,0.0,0.0,1.0))
WP2 = Pose(Point(2.0,1.0,0.0), Quaternion(0.0,0.0,0.0,1.0))
WP3 = Pose(Point(2.0,0.0,0.0), Quaternion(0.0,0.0,0.0,1.0))
WP4 = Pose(Point(0.0,0.0,0.0), Quaternion(0.0,0.0,0.0,1.0))
...
class SmartCart:
    ...
    def __init__(self):
        ...
        self.currentYaw = 0.0   #angle in radians relative to odom frame's positive x-axis; CCW is positive
        self.deltaYaw = 0.0 #difference between goal yaw and current yaw
...
#2) TURNING TO GOAL
    def turnToGoal(self):
        self.deltaYaw = self.get_deltaYaw()
        print("deltaYaw is:", (self.deltaYaw * 180 / PI), " degrees     &     currentYaw is:", (self.currentYaw * 180 / PI), " degrees")
